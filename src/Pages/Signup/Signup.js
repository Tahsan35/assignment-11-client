        ...
        <div className='flex justify-center items-center h-[92vh]'>
            <div className='w-[250px] sm:w-[500px] shadow-xl p-4 '>
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button onClick={handleGoogleSignIn} className='border rounded text-cyan-600 border-cyan-600 w-full flex items-center justify-around pt-1'><FcGoogle className='text-4xl' /><span className='text-lg'>Continue with google</span></button>
                </form>
            </div>
        </div>
    );
